...
RS485Device = "com2"  # RS485 serial device to be used
# This is limited to printing debig addressed to ID only
debugData = True
# Set this to True to print debug msg addressed anywhere
debugAll = True
debugRaw = False
...
logging.basicConfig(filename='poolboy.log', filemode='a', format='%(message)s', level=logging.DEBUG)
...
class Interface(object):
    ...
    def __init__(self, theName):
        ...
        self._open()
        if self.port == None:
            log("ERROR: Unable to create port")
            sys.exit(1)
        self.msg = "\x00\x00"
        self.debugRawMsg = ""
